...
export const EditorData = () => (
  <div>
    <h3>
      ...
      get started. First Examples The React homepage contains a few small React
      examples with a live editor. Even if you don’t know anything about React
      yet, try changing their code and see how it affects the result. React for
...
export const productsPerformance = [
  {
    image: product5,
    title: 'Is it good ice-cream?',
    desc: 'Ice-Cream, Milk, Powder',
    rating: 'Good',
    itemSold: '65%',
    earningAmount: '$636,000',
  },
  {
    image: product6,
    title: 'Supreme tomato',
    desc: 'Market, Mall',
    rating: 'Excellent',
    itemSold: '88%',
    earningAmount: '$830,000',
  },
  {
    image: product7,
    title: 'Red candy from Gucci',
    desc: 'Chocolate, Yummy',
    rating: 'Average',
    itemSold: '51%',
    earningAmount: '$317,000',
  },
  {
    image: product4,
    title: 'Stylish night lamp ',
    desc: 'Electric, Wire, Current',
    rating: 'Poor',
    itemSold: '22%',
    earningAmount: '$93,000',
  },
];
...
export const lineChartData = [
  [
    { x: new Date(2015, 0, 1), y: 22 },
    { x: new Date(2016, 0, 1), y: 25 },
    { x: new Date(2017, 0, 1), y: 30 },
    { x: new Date(2018, 0, 1), y: 34 },
    { x: new Date(2019, 0, 1), y: 51 },
    { x: new Date(2020, 0, 1), y: 53 },
    { x: new Date(2021, 0, 1), y: 69 },
  ],
  [
    { x: new Date(2015, 0, 1), y: 19 },
    { x: new Date(2016, 0, 1), y: 44 },
    { x: new Date(2017, 0, 1), y: 58 },
    { x: new Date(2018, 0, 1), y: 69 },
    { x: new Date(2019, 0, 1), y: 76 },
    { x: new Date(2020, 0, 1), y: 82 },
    { x: new Date(2021, 0, 1), y: 89 },
  ],

  [
    { x: new Date(2015, 0, 1), y: 5 },
    { x: new Date(2016, 0, 1), y: 25 },
    { x: new Date(2017, 0, 1), y: 35 },
    { x: new Date(2018, 0, 1), y: 49 },
    { x: new Date(2019, 0, 1), y: 58 },
    { x: new Date(2020, 0, 1), y: 87 },
